		...
		<table>
			<form method='POST' action='' >
              ...
              <td><input type="text" placeholder="level" name="rcc_level"></td>
					...
					<tr>
							<th class='EMP' colspan="6"><b>POSITION DESCRIPTION</b></th>
					</tr>
					<tr>
							<td colspan="6"><textarea id = "Position Requirements" name="posit_desc" rows="8" cols="200">Requirements and Responsibilities</textarea></td>
					</tr>
					<tr>
							<th class='EMP' colspan="6"><b>NOTES (Optional):</b></th>
					</tr>
					<tr><td colspan="6"><textarea id="Notes"  name="notes" rows="4" cols="200">Notes</textarea></tr>
					<tr>
            ...
            <td colspan="3"><a style="float: right"href='home.php'>Back</a>
